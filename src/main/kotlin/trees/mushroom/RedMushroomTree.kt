...
class RedMushroomTree : TreeType {
	...
	override fun gatherTreeData(blockPos: BlockPos, level: Level, player: Player): TreeData? {
		...
		return builder
			...
			.setMiningSpeedModifier { originalMiningSpeed ->
				...
				val multiplyAmount = fallingTreesCommonConfig.get().dynamicMiningSpeed.maxSpeedMultiplication.coerceAtMost((blocks.size.toFloat() - 1f))
